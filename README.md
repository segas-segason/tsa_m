...
if pval < 0.05:
    print("\nВывод: Нулевую гипотезу отвергаем → единичного корня НЕТ.")
    print("Первая разность ряда является стационарной.")
else:
    print("\nВывод: Нет оснований отвергать нулевую гипотезу → единичный корень ЕСТЬ.")
...
# Вывод
if kpss_stat > crit['5%']:
    print("\nВывод: Нулевую гипотезу о стационарности отвергаем → единичный корень ЕСТЬ.")
else:
    print("\nВывод: Нет оснований отвергать нулевую гипотезу о стационарности → единичного корня НЕТ.")
```
